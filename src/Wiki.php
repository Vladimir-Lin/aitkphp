...
// -| DoMinifier |-
//////////////////////////////////////////////////////////////////////////////
public static function AitkMinifier ( $HH , $AA                            ) {
  ////////////////////////////////////////////////////////////////////////////
  $AA [ "Answer" ] = "No"                                                    ;
  ////////////////////////////////////////////////////////////////////////////
  $MSG       = ""                                                            ;
...
// +| AitkCalendarLoader |+
//////////////////////////////////////////////////////////////////////////////
public static function AitkCalendarLoader ( $DB                              ,
                                            $PICKDB                          ,
                                            $HH                              ,
                                            $AA                              ,
                                            $Options                       ) {
  ...
  $OPTS        = $HH -> Parameter         ( "Options"                      ) ;
  $JSOX        = $HH -> Parameter         ( "JSON"                         ) ;
  ////////////////////////////////////////////////////////////////////////////
  $Templates   = $Options                 [ "Templates"                    ] ;
  $EXTENSION   = $Options                 [ "AITK"                         ] ;
  $PATHX       = $Options                 [ "Extension"                    ] ;
  ////////////////////////////////////////////////////////////////////////////
  $TEMPLFILE   = $Templates               [ "Calendar::FullCalendar"       ] ;
  $TEMPLFILE   = "{$PATHX}/{$TEMPLFILE}"                                     ;
  $FC          = file_get_contents        ( $TEMPLFILE                     ) ;
  ////////////////////////////////////////////////////////////////////////////
  $ID          = self::RandomString       ( "FullCalendar-" , 64           ) ;
  $MAPS        = array                                                       (
    "$(CALENDAR-ID)"       => $ID                                            ,
    "$(CALENDAR-OPTIONS)"  => json_encode ( $OPTS                          ) ,
    "$(CALENDAR-JSON)"     => json_encode ( $JSOX                          ) ,
  )                                                                          ;
  $MSG         = Strings::ReplaceByKeys   ( $FC , $MAPS                    ) ;
  ////////////////////////////////////////////////////////////////////////////
  $AA [ "Message" ] = $MSG                                                   ;
  $AA [ "Answer"  ] = "Yes"                                                  ;
  ////////////////////////////////////////////////////////////////////////////
...
// 行事曆
//////////////////////////////////////////////////////////////////////////////
public static function CalendarUI ( $argv , $Content , $Options            ) {
  ////////////////////////////////////////////////////////////////////////////
  $PICKDB    = self::GetTag       ( "database" , $argv                     ) ;
  $ID        = self::GetTag       ( "id"       , $argv                     ) ;
  if                              ( strlen ( $ID ) <= 0                    ) {
    $ID      = self::RandomString ( "FCBlock-" , 64                        ) ;
  }                                                                          ;
  ////////////////////////////////////////////////////////////////////////////
  $OPTS      = json_encode        ( $argv                                  ) ;
  ////////////////////////////////////////////////////////////////////////////
  $RT        = "<div id='{$ID}'></div>"                                      ;
  $RT        = "{$RT}<script type='text/javascript'>"                        ;
  $RT        = "{$RT}$(document).ready(function(){"                          ;
  $RT        = "{$RT}AitkCalendarLoader('{$PICKDB}','{$ID}',{$OPTS},{$Content});" ;
  $RT        = "{$RT}});</script>"                                           ;
  ////////////////////////////////////////////////////////////////////////////
  return $RT                                                                 ;
}
