...
public function StarDate       ( $SDT                                      ) {
  if                           ( is_a ( $SDT , "AITK\StarDate" )           ) {
    $this -> Stardate = $SDT -> Stardate                                     ;
  } else                                                                     {
    $this -> Stardate = intval ( $SDT , 10                                 ) ;
  }                                                                          ;
}
//////////////////////////////////////////////////////////////////////////////
...
public function Minutes   ( $M                                             ) {
  return intval           ( intval ( $M , 10 ) *    60 , 10                ) ;
}
//////////////////////////////////////////////////////////////////////////////
public function Hours     ( $H                                             ) {
  return intval           ( intval ( $H , 10 ) *  3600 , 10                ) ;
}
//////////////////////////////////////////////////////////////////////////////
public function Days      ( $D                                             ) {
  return intval           ( intval ( $D , 10 ) * 84600 , 10                ) ;
}
//////////////////////////////////////////////////////////////////////////////
public function Add           ( $S                                         ) {
  $this -> Stardate += intval ( $S , 10                                    ) ;
  return $this -> Stardate                                                   ;
}
//////////////////////////////////////////////////////////////////////////////
