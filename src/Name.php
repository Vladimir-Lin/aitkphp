...
//////////////////////////////////////////////////////////////////////////////
public function LocateId     ( $DB , $Table                                ) {
  ////////////////////////////////////////////////////////////////////////////
  $UX = $this -> Uuid                                                        ;
  $LX = $this -> Locality                                                    ;
  $RX = $this -> Relevance                                                   ;
...
//////////////////////////////////////////////////////////////////////////////
public function isExistsId   ( $DB , $Table                                ) {
  ////////////////////////////////////////////////////////////////////////////
  $IDX = $this -> LocateId   ( $DB , $Table                                ) ;
  if                         ( strlen ( $IDX ) <= 0                        ) {
    return false                                                             ;
  }                                                                          ;
  $V   = intval              ( $IDX , 10                                   ) ;
...
//////////////////////////////////////////////////////////////////////////////
public function UpdateFlagsById ( $DB , $TABLE                             ) {
  $ID    = $this -> Id                                                       ;
  $FLAGS = $this -> Flags                                                    ;
  $QQ    = "update {$TABLE} set `flags` = {$FLAGS} where `id` = {$ID} ;"     ;
  return $DB -> Query           ( $QQ                                      ) ;
}
//////////////////////////////////////////////////////////////////////////////
public function UpdatePriorityById ( $DB , $TABLE                          ) {
  $ID       = $this -> Id                                                    ;
  $PRIORITY = $this -> Priority                                              ;
  $QQ       = "update {$TABLE} set `priority` = {$PRIORITY} where `id` = {$ID} ;" ;
  return $DB -> Query           ( $QQ                                      ) ;
}
//////////////////////////////////////////////////////////////////////////////
